...
import 'FuzzImages.dart';
// These are just sample data to show in the app you can use your own data or make it dynamic according to your need
...
List<Restaurants> addBakeryData() {
  ...
  bakeryData.add(Restaurants("Live Cake & Bakery Shop", 4, food_ic_popular2, "150 Reviews"));
  bakeryData.add(Restaurants("Richie Rich Cake Shop", 2, food_ic_item12, "50 Reviews"));
  bakeryData.add(Restaurants("Dry Fruit Ice Cream", 5, food_ic_item1, "50 Reviews"));
...
List<Restaurants> addDeliveryRestaurantsData() {
  ...
  deliveryRestaurantsData.add(Restaurants("Chinese", 4, food_ic_popular4, "50 Reviews"));
