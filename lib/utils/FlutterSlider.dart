...
class FlutterSliderState extends State<FlutterSlider> with TickerProviderStateMixin {
  ...
  void initMethod() {
    ...
    Offset animationFinish = const Offset(0, -1);
  ...
  void _drawHatchMark() {
    ...
    hatchMark.smallLine = widget.hatchMark!.smallLine ?? const FlutterSliderSizedBox(height: 5, width: 1, decoration: BoxDecoration(color: Colors.black45));
    hatchMark.bigLine = widget.hatchMark!.bigLine ?? const FlutterSliderSizedBox(height: 9, width: 2, decoration: BoxDecoration(color: Colors.black45));
    hatchMark.labelBox = widget.hatchMark!.labelBox ?? const FlutterSliderSizedBox(height: 35, width: 50);
    ...
    for (int p = 0; p <= percent; p++) {
      ...
      if (widget.hatchMark!.labels!.isNotEmpty) {
      ...
      List<Widget> barContents = [barLine, ...labelWidget];
  ...
  void _setParameters() {
    ...
    _tooltipData.boxStyle = _tooltipData.boxStyle ?? FlutterSliderTooltipBox(decoration: BoxDecoration(border: Border.all(color: Colors.black12, width: 0.5), color: const Color(0xffffffff)));
    _tooltipData.textStyle = _tooltipData.textStyle ?? const TextStyle(fontSize: 12, color: Colors.black38);
    _tooltipData.leftPrefix = _tooltipData.leftPrefix;
    _tooltipData.leftSuffix = _tooltipData.leftSuffix;
    _tooltipData.rightPrefix = _tooltipData.rightPrefix;
    _tooltipData.rightSuffix = _tooltipData.rightSuffix;
  ...
  void _generateHandler() {
    ...
    inputRightHandler.decoration ??= const BoxDecoration(boxShadow: [BoxShadow(color: Colors.black26, blurRadius: 2, spreadRadius: 0.2, offset: Offset(0, 1))], color: Colors.white, shape: BoxShape.circle);
...
//                            color: Colors.blue.withOpacity(0.7),
  ...
  drawHandlers() {
    List<Positioned> items = [Function.apply(_inactiveTrack, []),
    ...
    items.add(Positioned(
        ...
        child: Opacity(
          ...
          child: Listener(
            ...
            onPointerMove: (_) {
              if (_ignoreSteps.isEmpty && _distanceFromRightHandler! > 0 && _distanceFromLeftHandler! < 0) {
...
//    }
  ...
  Positioned _activeTrack() {
    ...
    Color trackBarColor = boxDecoration.color ?? const Color(0XFFfc4a1a);
...
class _MakeHandler extends StatelessWidget {
  ...
  const _MakeHandler({this.id, this.handlerData, this.visibleTouchArea, this.width, this.height, this.animation, this.rtl = false, this.rangeSlider = false, this.axis, this.handlerIndex, this.touchSize});
...
class FlutterSliderHandler {
  ...
  @override
  String toString() {
    return '$child-$disabled-$decoration-$foregroundDecoration-$transform';
  }
}
...
class FlutterSliderTooltip {
  ...
  @override
  String toString() {
    return '$textStyle-$boxStyle-$leftPrefix-$leftSuffix-$rightPrefix-$rightSuffix-$alwaysShowTooltip-$disabled';
  }
}
...
class FlutterSliderHatchMark {
  ...
  @override
  String toString() {
    return '$disabled-$density-$distanceFromTrackBar-$labels-$smallLine-$bigLine-$labelBox';
  }
}
