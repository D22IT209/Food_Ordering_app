...
class FoodWalkThroughState extends State<FoodWalkThrough> {
  ...
  var subTitles = [
    "Find delicious dining options right around the corner with our intuitive food ordering app! ",
    "Discover simplicity in every savory bite with our mouthwatering dishes!  ",
    "Welcome to our food ordering app, where convenience meets culinary delight – get ready to experience a world of flavor at your fingertips!"
  ];
